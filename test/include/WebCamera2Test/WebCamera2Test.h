  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  WebCamera2Test(RTC::Manager* manager);

  /*!
   * @brief destructor
   */
  ~WebCamera2Test() override;
...
extern "C"
{
  DLL_EXPORT void WebCamera2TestInit(RTC::Manager* manager);
};

#endif // WEBCAMERA2_TEST_H
